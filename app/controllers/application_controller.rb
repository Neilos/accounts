class ApplicationController < ActionController::Base
  ...
  def sankey
    data = {
      "nodes" => [
        {"name" => "nodep", "id"=>"p", "parent" => nil},
        {"name" => "node1", "id"=>1, "parent" => "p"},
        {"name" => "node2", "id"=>2, "parent" => "p"},
        {"name" => "node3", "id"=>3, "parent" => "p"},
        {"name" => "node4", "id"=>4, "parent" => "p"},
        {"name" => "nodeq", "id"=>"q", "parent" => nil},
        {"name" => "node5", "id"=>5, "parent" => "q"},
        {"name" => "node6", "id"=>6, "parent" => "q"},
        {"name" => "node7", "id"=>7, "parent" => "q"},
        {"name" => "node8", "id"=>8, "parent" => nil},
        {"name" => "node9", "id"=>9, "parent" => nil},
        {"name" => "node10", "id"=>10, "parent" => nil},
        {"name" => "node11", "id"=>11, "parent" => nil},
        {"name" => "node12", "id"=>12, "parent" => nil},
        {"name" => "node13", "id"=>13, "parent" => nil},
        {"name" => "node14", "id"=>14, "parent" => nil},
        {"name" => "node15", "id"=>15, "parent" => nil},
      ],
      "links" => [
